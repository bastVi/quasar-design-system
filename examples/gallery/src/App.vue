...
type GalleryTab = 'tokens' | 'typography' | 'components' | 'catalog' | 'scenes' | 'plugins' | 'icons' | 'fonts'

const tabs: GalleryTab[] = ['tokens', 'typography', 'components', 'catalog', 'scenes', 'plugins', 'icons', 'fonts']
